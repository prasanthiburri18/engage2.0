...
public class PatientService {
	...
	public List<PatientDto> getPatientsByPhoneNumber(String phone)
	...
	public List<PatientDto> getPatientByDob(String dob)
		...
		try {
			...
			throw new InvalidDateOfBirthException(
					"Date of birth format passed in invalid. " + e.getMessage());
		}

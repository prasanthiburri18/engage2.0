...
public class SchedulerController {
	...
	@RequestMapping(value = "/sendSmsScheduledDataorg", method = RequestMethod.POST) // every
																						// 30
																						// seconds
	public @ResponseBody JsonMessage pullRandomComment() {
		...
		try {
			...
			// List<Object> pathway=(List<Object>)
			// restTemplate.postForObject("http://35.166.195.23:8080/PathwayMicroservice/api/v1/getScheduledData",
			// data1,Object.class );
			List<Object> pathway = (List<Object>) restTemplate.postForObject(pathwayMicroserviceUrl+"/api/v1/getScheduledData", data1,
					Object.class);

			// List<Object> pathway=(List<Object>)
			// restTemplate.postForObject("http://localhost:8081/api/v1/getScheduledData",
			// data1,Object.class );
			...
			for (Object obj : pathway) {
				...
				// Map<String,Object> patientdata=(Map<String,Object>)
				// restTemplate.postForObject("http://35.166.195.23:8080/PatientMicroservice/api/v1/getPatientsPathwayIdAndEventId",
				// data2,Object.class );
				Map<String, Object> patientdata = (Map<String, Object>) restTemplate.postForObject(
						patientMicroserviceUrl + "/api/v1/getPatientsPathwayIdAndEventId", data2, Object.class);

				// Map<String,Object> patientdata=(Map<String,Object>)
				// restTemplate.postForObject("http://localhost:8082/api/v1/getPatientsPathwayIdAndEventId",
				// data2,Object.class );
				...
				final SmsFactory messageFactory = mainAccount.getSmsFactory();
				final List<NameValuePair> messageParams = new ArrayList<NameValuePair>();
				messageParams.add(new BasicNameValuePair("To", "+91" + patientdata.get("phone").toString())); // Replace
																												// with
																												// a
																												// valid
																												// phone
	...
	/**
	 * Loading Patient Message blocks for schedule run
	 * 
			...
			for (int i = 0; i < Res.size(); i++) {
				...
				if (!message.equals("Signup") && !message.equals("") && messagestatus.equals("scheduled")) {
					...
					messageParams.add(new BasicNameValuePair("To", countryCode + pph)); // Replace
																					...
																					// phone
																					// number
					messageParams.add(new BasicNameValuePair("From", fromNumber)); // Replace
																					// with
																					// a
																					// valid
																					// phone
	...
	/**
	 * Loading Patient Message blocks for schedule run for same day message
	 * deliver
	 * 
	 * @Inputparam Patient JsonObject
	 * @return JsonObject
	...
	/**
	 * Schedule Data Method for Inner rest template usage
	 * 
	 * @Inputparam Patient JsonObject
	 * @return JsonObject
	 */
	@RequestMapping(value = "/sendSmsScheduledData", method = RequestMethod.POST) // every
																					// 30
																					// seconds

...
DROP TABLE IF EXISTS `userdb`.`qc_encrypt_key`;
CREATE TABLE `userdb`.`qc_encrypt_key` (
  `id` int(11) NOT NULL,
  `key` varchar(50) NOT NULL,
  `is_active` char NOT NULL,
  PRIMARY KEY (`id`),
...
insert into `userdb`.qc_encrypt_key(id, `key`,`is_active`) values(1,"Secure@helthapi1", 'Y');
commit;

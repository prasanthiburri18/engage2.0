...
(function(t) {
    ...
    var Ke = ue.extend({
        ...
        sn = Le.Grid = rn.extend({
            ...
            headCellHtml1: function(t) {
                var e = this.view,
                    n = t.start;
                return '<th class="fc-day-header ' + e.widgetHeaderClass + " fc-" + Be[n.day()] + '">Event- ' + Y(n.format(this.colHeadFormat)) + "</th>"
            },
            ...
            //lakshmi::COls
             headCellHtml: function(t) {
                ...
                var e = this.view,
                    n = t.start;
                return '<th class="fc-day-header ' + e.widgetHeaderClass + " fc-" + Be[n.day()] + '">Event- ' + t.col + "</th>"
            },
            ...
            getDayClasses: function(t) {
                console.log('lakhsmi checking for first column');
                console.log(t);
                var e = this.view,
    ...
    var ln = sn.extend({
        ...
        //lakshmi::Rows
         slatRowHtml: function() {
             ...
             for (var i=0;i < 16;i++)
             {
             var tdcol='<tr style="height:80px;"><td class="fc-axis fc-time fc-widget-content " style="width:40px !important;"> Day '+(i+1)+'</td><td class="fc-widget-content"></td></tr>';
               dayhtml+=tdcol;  
             }
             return dayhtml;
//  for (var t, n, i, r = this.view, s = this.isRTL, o = "", l = 0 === this.slotDuration.asMinutes() % 15, 
//  a = e.duration(+this.minTime); this.maxTime > a;) 
//      t = this.start.clone().time(a), n = t.minutes(),
//  i = '<td class="fc-axis fc-time ' + r.widgetContentClass + '" ' + r.axisStyleAttr() + "> D-</td>", 
//  o += "<tr style='height:80px;'>" + i+ '<td class="' + r.widgetContentClass + '"/>' +iw+ "</tr>", a.add(this.slotDuration);
//            return o

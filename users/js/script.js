								...
								.ajax({
									...
									success : function(response) {
										...
										if (response != null) {
											...
											var ajaxurl = userapibase
													+ "/api/v1/userbasicinfo"
											$
													.ajax({
														url : ajaxurl,
														type : 'GET',
											...
											$("#error")
													.fadeIn(
															...
															function() {
																$("#error")
																		.html(
																				'<div class="alert alert-danger">Incorrect Email/Password combination. Please try again</div>');
